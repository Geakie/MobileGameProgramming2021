...
public class RenderBackground implements EntityBase{
    ...
    public void Init(SurfaceView _view){
        ...
        bmp= BitmapFactory.decodeResource(_view.getResources(),R.drawable.standardgame);
    ...
    public void Update(float _dt){
        ...
        yPos-=_dt*100; //deals with the speed of moving the screen
    ...
    public void Render(Canvas _canvas){
        ...
        _canvas.drawBitmap(scaledbmp,xPos,yPos+ScreenHeight,null); //2nd image (to show its continuous)
